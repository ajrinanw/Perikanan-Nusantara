...
<body>
    <!--  Navbar -->
    <div class="navbar">
        <img src="assets/img/logo_bulat.png" height="50px">
                ...
                <div class="text">
                    <h1 style="font-weight: bold">
                        ...
                        <div class="deskripsi1">
                            Perusahaan Umum Perikanan Indonesia  merupakan badan usaha milik negara (BUMN) <br>
                            yang didirikan berdasarkan Peraturan Pemerintah (PP) Nomor 2 Tahun 1990  yang  <br>
                            terbit tanggal 20 Januari 1990 dengan nama Perusahaan Umum Prasarana Perikanan <br>
                            Samudera (Perum PPS). Lalu, diatur kembali dengan Peraturan Pemerintah Nomor 23<br>
                            Tahun 2000. Tahun 2013 terbit PP Nomor 9 yang antara lain mencantumkan perubahan<br>
                            nama perusahaan, menjadi Perusahaan Umum Perikanan Indonesia atau disingkat<br>
                            sebagai Perum Perindo. <br>   
</br>
                        </div>
                    </h1>
            ...
            <div class="row gap-md-0 gap-3">
                <div class="col-lg-3 col-md-6">
                    <div class="">
                        <div class="list-space">
                            <img src="assets/img/logo_bulat.png" alt="" style="max-height:180px;"/>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <li class="list-space">
                            ...
                            <li class="list-space">
                                <a href="#" class="list-menu">Article</a>
                            </li>
                            <li class="list-space">
                ...
                <div class="col-lg-3 col-md-6">
                    <h2 class="footer-text-title">Address
        ...
        <div class="border-color info-footer">
            ...
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                ...
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                    <p style="margin: 0">Copyright © 2021 | K3520009-K3520013-K3520081</p>
                </nav>
            </div>
        </div>
    </div>
